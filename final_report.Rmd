...
```{r}
cpi <- cpidata %>%
  select(-cpiREC,-cpiEDUC)%>%
  pivot_longer(cols=c("cpiTUITION","cpiALLITEMS","cpiENERGY","cpiHOUSING","cpiMEDICAL",  "cpiFOODBEV","cpiTRANSP","cpiAPPAREL"),names_to='cpi_type',values_to = "cpi_value")
...
animate(cpigraph, width = 700, height = 425, fps = 15, duration = 40, rewind = FALSE, start_pause = 25, end_pause = 25)
