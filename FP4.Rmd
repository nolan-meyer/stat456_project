...
We began by first exploring who typically has to borrow the most to pay for college. To do this we looked at the amount students borrowed for their undergraduate studies in 2016, and differentiated by race and gender.
...
This plot clearly shows that across the board, on average female students had to borrow more in 2016 than male students. This could be partly due to the fact that female students represent a slight majority in college enrollment, which extends to private enrollment which is generally more expensive. Still, this plot shows a stark difference between the two genders in the amount borrowed for undergrad.
