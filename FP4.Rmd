...
If a segment is inelastic (|Slope| < 1), it means the following:

- 1. The gender that borrows less borrows a lot less even though it is able to pay a little bit more based on EFC.  
...
If a segment is elastic (|Slope| > 1), it means the following:

- 1. The gender that borrows less borrows a little less even though it is able to pay a lot more based on EFC.
