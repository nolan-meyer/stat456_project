...
- By Tue, Nov. 22 (before break):
    ...
    - Incorporate feedback from intermediate presenation
    
    - Aquire any last data sources we may want to add in our analyses
...
- By Thur, Dec. 8:
    ...
    - Be prepared for the final presenations (have practiced presenting, who's talking about what, etc.)
...
- Pulled and cleaned data relating to that plot, and also provided much of the analysis

- Build the slide deck for the presentation
