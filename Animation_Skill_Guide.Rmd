...
One last thing we should make sure to add to our animation is how the animation is transitioning. While we know the animation is changing by year, our viewer may not realize or understand that. With some transition functions this may or may not be easily  inferable, so it's good practice to include this information on the plot. We can add this information in the **labs()** part of our ggplot creation, specifying one of the corresponding transition states related to the transition function we are using (see below).
