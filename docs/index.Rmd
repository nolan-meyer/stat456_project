...
Transition functions also have a few common arguments that useful to know as you often will want to adjust these. Typically, whatever variable you are animating on goes first. In addition, the other main ones are:
...
There are of course other arguments specific to each transition function, however these are crucial ones to know when building animations.
